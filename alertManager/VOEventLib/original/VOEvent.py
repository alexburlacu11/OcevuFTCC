...
#
# Generated Wed Jul 21 16:00:37 2010 by generateDS.py version 2.1a.
#
...
class Param(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, dataType='string', unit=None, ucd=None, name=None, value=None, Description=None, Reference=None):
...
class Table(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, type_=None, name=None, Description=None, Reference=None, Field=None, Data=None):
        self.type_ = _cast(None, type_)
        self.name = _cast(None, name)
        if Description is None:
            self.Description = []
...
class Field(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, dataType='string', ucd=None, name=None, unit=None, Description=None, Reference=None):
        self.dataType = _cast(None, dataType)
        self.ucd = _cast(None, ucd)
        self.name = _cast(None, name)
        self.unit = _cast(None, unit)
